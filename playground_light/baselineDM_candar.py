...
from method.change_de.dm_candar import dm_method as dm_method
            ...
            for I in IS:
                ...
                for i in range(data.get_file_lenght()):
                    ...
                    for index, instance in enumerate(instances):
                        result_cheb = cheb.add_element(instance)
                        dm.add_element(result_cheb.detected_change())
                ...
                data.save_result_to_csv(dataset_index=0,threshold_after = 100,L=L,I=I,Algorithm="Base Cheb 500 DM",Dataset_type=type,pattern=pattern)